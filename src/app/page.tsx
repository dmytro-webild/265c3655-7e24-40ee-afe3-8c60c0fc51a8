...
export default function LandingPage() {
  ...
  <div id="services-home" data-section="services-home">
      ...
      features={[
        { icon: Zap, title: "AI Automation", description: "Streamlining complex tasks with advanced AI logic." },
        { icon: Code, title: "Web Development", description: "High-performing custom web and mobile apps." },
        { icon: Database, title: "CRM Automation", description: "Data-driven customer lifecycle management." },
      ]}
      title="Core Services"
  ...
  <div id="benefits" data-section="benefits">
      ...
      metrics={[
        { id: "m1", value: "100+", title: "Processes Automated", items: ["Scalability", "Reliability", "Efficiency"] },
        { id: "m2", value: "50+", title: "Projects Delivered", items: ["Quality", "Innovation", "Speed"] },
        { id: "m3", value: "99%", title: "Client Satisfaction", items: ["Commitment", "Growth", "Result-Oriented"] },
      ]}
  ...
  <div id="pricing" data-section="pricing">
      ...
      useInvertedBackground={true}
      plans={[
        { id: "p1", badge: "Essential", price: "$1,500", subtitle: "Basic Workflow Automation", buttons: [{ text: "Get Started", href: "/contact" }], features: ["Workflow Analysis", "Bot Setup", "24/7 Support"] },
        { id: "p2", badge: "Professional", price: "$3,500", subtitle: "Comprehensive Business AI", buttons: [{ text: "Choose Pro", href: "/contact" }], features: ["CRM Automation", "Lead Gen Systems", "Priority Support"] },
        { id: "p3", badge: "Enterprise", price: "Custom", subtitle: "End-to-End Solutions", buttons: [{ text: "Consult Us", href: "/contact" }], features: ["Custom AI Models", "Full ERP Integration", "Dedicated Team"] },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      avatars={[
        ...
        { src: "http://img.b2bpic.net/free-photo/smiling-young-businessman-with-thumb-up-tablet_1262-2010.jpg", alt: "Client 2" },
        { src: "http://img.b2bpic.net/free-photo/happy-mature-business-man-standing-office-cafe-leaning-counter-holding-jacket-shoulder-showing-thumb-up_74855-15159.jpg", alt: "Client 3" },
        { src: "http://img.b2bpic.net/free-photo/handshake-with-smiling-businessman_23-2147708181.jpg", alt: "Client 4" },
        { src: "http://img.b2bpic.net/free-photo/young-successful-businessman-smiling-posing-with-crossed-arms-office_176420-914.jpg", alt: "Client 5" },
      ]}
  ...
  <div id="faq" data-section="faq">
      ...
      useInvertedBackground={false}
      faqs={[
        { id: "f1", title: "How does AI automation work?", content: "We connect your business platforms with custom AI logic to automate repetitive workflows." },
        { id: "f2", title: "What industries do you serve?", content: "We support healthcare, logistics, e-commerce, and B2B sales agencies." },
        { id: "f3", title: "Is the solution scalable?", content: "Yes, our systems are built on robust cloud architectures to grow with you." },
        { id: "f4", title: "How fast is delivery?", content: "Our typical setup for MVP solutions is within 2-4 weeks depending on complexity." },
        { id: "f5", title: "What is the team expertise?", content: "We are a team of AI automation experts and dedicated software engineers." },
        { id: "f6", title: "Do you offer support?", content: "Post-launch maintenance and optimization support is included with our packages." },
      ]}
